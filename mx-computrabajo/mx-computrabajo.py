...
def get_num_pages():
    url='https://www.computrabajo.com.mx/ofertas-de-trabajo/?p={}'.format(1)
...
def get_urls_empleos(num):
    ...
    lista_url_empleos=['https://www.computrabajo.com.mx'+urls.get('href') for urls in urls_ofertas]
...
def data_retrieval(url):
    ...
    filename = f"mx-computrabajo/vacantes/{id_job_by_url}-{fecha_busqueda}.json"

    # Crea la carpeta si no existe
    if not os.path.exists('mx-computrabajo/vacantes'):
        os.makedirs('mx-computrabajo/vacantes')
